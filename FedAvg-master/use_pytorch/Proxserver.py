...
if __name__=="__main__":
    ...
    for i in range(args['num_comm']):
        ...
        for client in tqdm(clients_in_comm):
            ...
            if sum_parameters is None:
                ...
                for key, var in local_parameters.items():
                    sum_parameters[key] = var.clone() * 0.05
            else:
                for var in sum_parameters:
                    sum_parameters[var] = sum_parameters[var] + local_parameters[var] * 0.05
            cl+=1
        ...
        #                                                                                         args['num_of_clients'],
        #                                                                                         args['cfraction'])))
        np.savetxt('AccuracyProx,IID,mu=0.01.txt', Accuracy)
