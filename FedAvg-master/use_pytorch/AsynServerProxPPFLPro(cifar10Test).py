...
if __name__ == "__main__":
    ...
    for i in range(args['num_comm']):
        ...
        if (i + 1) % args['save_freq'] == 0:
            ...
            #                                                                                     args['num_of_clients'],
            #                                                                                     args['cfraction'])))
        r = os.getcwd() + "\\nonIID\FedProx_AsyAccuracy_PPFLPro\cifar10"
        np.savetxt(r + '\cnn2_FedProx_AsyAccuracy_Pro(staleThreshold={},percent={},mu={},threshold={},100stale,notAggUnderThre,5local,0.02lr,newflag).txt'.format(
